...
class Config:
    ...
    exact_match_keywords: List[str] = field(default_factory=lambda: ["我", "我我", "我我我"])
    ...
    # UI操作步骤间的微小延迟 (秒)
    step_delay_min: float = 0.3
    step_delay_max: float = 0.5

    # 提交回复后的等待时间 (秒)
    submit_result_delay_min: float = 0.8
    submit_result_delay_max: float = 1.5
